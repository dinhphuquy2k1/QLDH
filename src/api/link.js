 ...
 * **/
export function loadData(pageIndex, pageSize, filter) {
    return service({
        url: `Emulation/filter?pageIndex=${pageIndex}&pageSize=${pageSize}&filter=${filter}`,
        method: 'get'
    })
}
/**
 ...
 * author:DPQuy (13/11/2022)
 * **/
export function getNewEmulationCode() {
    return service({
